...
{
    public class NbrFileByTime : IStatChart
    {
        public string Title
        {
            get { return Resources.Languages.Resources.Gr_NumberOfFile; }
        }
        ...
        public string Sql
        {
            ...
            {
                return
                    "select NumberOfFile as nombre,startDate as date from duplicatefile.stats";
            }
        }
